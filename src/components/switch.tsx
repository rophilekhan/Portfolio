...
interface SwitchProps {
    setActiveButton: () => void;
    activeButton: React.ReactNode; // Accept activeButton as a prop
    hiddenButton: React.ReactNode; // Accept hiddenButton as a prop
}
        ...
        <div className="relative">
            <AnimatePresence>
                {isHovered && (
                    ...
                    >
                        <div className="bg-white dark:bg-gray-950 rounded-full p-3 shadow-lg">
                            {hiddenButton} {/* Use hiddenButton prop here */}
                        </div>
                    </motion.div>
                )}
            </AnimatePresence>
            ...
            <motion.button
                ...
                onMouseLeave={() => setIsHovered(false)}
            >
                {activeButton} {/* Use activeButton prop here */}
            </motion.button>
        </div>
    );
}